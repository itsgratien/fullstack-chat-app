...
export const ConversationItem = ({ item, handleClick, activeConversation }: Props) => {
  ...
  return (
    <li
      onClick={() => handleClick(item.conversationId)}
      className={classNames(
        activeConversation === item.conversationId && style.activeConversation
      )}
    >
